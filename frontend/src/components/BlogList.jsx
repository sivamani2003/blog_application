...
const BlogList = () => {
  ...
  const likeBlog = async (id) => {
    try {
      await axios.post(`https://blog-application-i20m.onrender.com/api/blogs/${id}/like`);
      fetchBlogs();
    } catch (error) {
  ...
  const dislikeBlog = async (id) => {
    try {
      await axios.post(`https://blog-application-i20m.onrender.com/api/blogs/${id}/dislike`);
      fetchBlogs();
    } catch (error) {
